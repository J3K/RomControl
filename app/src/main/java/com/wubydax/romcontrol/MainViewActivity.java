...
public class MainViewActivity extends AppCompatActivity
    ...
    public List<NavItem> getMenu() {
        ...
        * 8. You need to add same items to the int array in NavigationDrawerFragment, which has the same method*/
        ...
        int[] mIcons = {R.drawable.systemui,
        ...
        * See more detailed instructions on the thread or in annotations to the previous method*/
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new NotificationFragment()).commitAllowingStateLoss();
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new TouchWizzFragment()).commitAllowingStateLoss();
                break;
            case 5:
            ...
            case 6:
                ...
                break;
            case 7:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new backupFragment()).commitAllowingStateLoss();
                break;
            case 8:
